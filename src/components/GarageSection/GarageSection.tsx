...
export const GarageSection = () => {
  return (
    <section
      ...
      id="GarageISEP"
    >
      <AnimationSide classNames="w-10/12 sm:w-3/5 lg:w-2/5 sm:ml-16 xl:ml-20">
        <div>
          <Image
            src={'/g-logo-h-w.svg'}
            alt={''}
          ...
          <p className="mt-4 sm:mt-10 mb-6 sm:mb-10 text-white text-lg sm:text-xl text-center sm:text-left">
            ...
            membres développent des projets innovants, organisent des
            conférences ou des workshops, et participent à des hackathons.
          </p>
